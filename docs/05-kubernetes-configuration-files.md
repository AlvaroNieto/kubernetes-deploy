...
In this lab I will generate [Kubernetes client configuration files](https://kubernetes.io/docs/concepts/configuration/organize-cluster-access-kubeconfig/), typically called kubeconfigs, which configure Kubernetes clients to connect and authenticate to Kubernetes API Servers.

### Client Authentication Configs

In this section I will generate kubeconfig files for the `kubelet` and the `admin` user.
